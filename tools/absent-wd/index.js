...
.then(async () => {
	...
	{
		//TODO: cache?
		const queryResult = await runQuery("SELECT ?item ?itemLabel ?itemDescription WHERE { ?item wdt:P31 [wdt:P279* wd:Q20643955]. SERVICE wikibase:label { bd:serviceParam wikibase:language \"[AUTO_LANGUAGE],mul,en\". }}")
